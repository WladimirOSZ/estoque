...
first_lot = Lot.create!(code: 'ABC123', start_date: '2021-05-01 10:15:00', end_date: 1.day.from_now,
                        minimum_value: 100, minimum_difference: 10,
                        created_by: first_admin, approved_by: second_admin)

second_lot = Lot.create!(code: 'ABC111', start_date: '2021-05-01 10:15:00', end_date: 1.day.from_now,
...
fifth_item = Item.create!(
  ...
  photo: tvsamsung_image, weight: 12_000, width: 120, height: 70, depth: 10, user_id: first_admin.id
)
...
sixth_item = Item.create!(
  ...
  photo: motoyamaha_image, weight: 12_000, width: 120, height: 70, depth: 10, user_id: first_admin.id
)
...
seventh_item = Item.create!(
  ...
  photo: gol_gw, weight: 12_000, width: 120, height: 70, depth: 10, user_id: first_admin.id
)

eight_item = Item.create!(
  name: 'GOL TURBO',
  description: 'VW GOL GTS PLACA KCG0165 SEBASTIANOPOLIS DO SUL - ANO 87/87 - COR CINZA - COMB ALCOOL - CHASSI 9BWZZZ30ZHT066498 - MOTOR UE182622 - RENAVAN 112936709 - SUCATA SEM DIREITO A DOCUMENTO - MELHOR CARRO JÁ FEITO NO BRASIL.',
  photo: gol_gw2, weight: 12_000, width: 120, height: 70, depth: 10, user_id: first_admin.id
)
